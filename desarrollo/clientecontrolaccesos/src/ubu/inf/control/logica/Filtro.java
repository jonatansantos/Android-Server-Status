...
public class Filtro extends Activity {
	...
	private void inicializa() {
		// pongo la fecha
		datedesde = new Date(mYear_desde,mMes_desde,mDay_desde,mHora_desde,mMinuto_desde);
	
		datehasta = new Date();
		mDay_hasta = datehasta.getDay();
	...
	protected void updateDisplay() {
		...
		desde_hora.setText(mHora_desde+":"+mMinuto_desde);
		hasta_hora.setText(mHora_hasta+":"+mMinuto_hasta);
