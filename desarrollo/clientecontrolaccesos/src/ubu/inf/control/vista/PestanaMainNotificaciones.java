...
public class PestanaMainNotificaciones extends Activity {
	...
	/**
	 * Handler para manejar los mensajes del hilo asíncrono cuando se borran
	 * notificaciones.
	 * 
	 * @author David Herreo de la Peña
	 * @author Jonatan Santos Barrios
	...
	/**
	 * Función para borrar una notificacion de la base de datos del servidor.
	 * 
	 * @param not
...
//		 datos.add(aux);
	...
	/**
	 * Función que realiza la conexión con el servidor para obtener las nuevas
	...
	/**
	 * Función que realiza la conexión con el servidor para obtener las
	...
	protected void onStart() {
		...
		if (getIntent().getExtras() != null) {
			if(!filtroenviado){
				...
				Log.i("control", "han llamado a la pestaña desde filtro ");
				filtroenviado=false;
			}
