...
public class FachadaCoordenadas {
	...
	/**
	 * Función que retorna la instancia única de de FachadaCoordenadas.
	 * 
	 * @param context
	...
	/**Función que retorna todas las entradas de la base de datos, va metiendo todos los datos en 
	 * los distintos arrays que se le pasan como parámetros.
	 * 
	 * @param id array donde se colocarán los id.
	 * @param longitud array donde se colocarán las longitudes.
	 * @param latitud array donde se colocarán las latitudes.
	 * @param fecha array donde se colocarán las fechas , en segundos 
	 */
	...
	/**Función que retorna todas las últimas entradas de la base de datos, va metiendo todos los datos en 
	 * los distintos arrays que se le pasan como parámetros.
	 * 
