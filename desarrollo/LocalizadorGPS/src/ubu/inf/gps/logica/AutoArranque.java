...
/**
 * Clase que hereda de BroadcastReceiver, se encarga de iniciar un servicio
 * concreto cuando ocurre un evento declarado en el manifest, en este caso
 * cuando el teléfono termina de encenderse.
 * 
